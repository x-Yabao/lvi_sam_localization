...
std::pair<double, int> SCManager::distanceBtnScanContext( MatrixXd &_sc1, MatrixXd &_sc2 )
{
    ...
    MatrixXd vkey_sc1 = makeSectorkeyFromScancontext( _sc1 );       // cur
    MatrixXd vkey_sc2 = makeSectorkeyFromScancontext( _sc2 );       // candidate
...
void SCManager::removeLastScancontextAndKeys()
{
